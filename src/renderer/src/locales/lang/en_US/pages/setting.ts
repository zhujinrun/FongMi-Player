export default {
  ...
  gateway: {
    ...
    tip: 'Optional TVBox config URL to reload Gateway; empty = sync currently loaded sources',
    configUrl: 'Config URL',
    gatewayBase: 'Gateway URL',
    gatewayBaseTip: 'Default http://127.0.0.1:9979',
    confirm: 'Start sync',
    success: 'Sync done',
    fail: 'Sync failed',
    empty: 'No data to sync',
    status: 'Status',
    running: 'Running',
    starting: 'Started (checking)',
    stopped: 'Stopped',
    actions: 'Actions',
    start: 'Start',
    stop: 'Stop',
    restart: 'Restart',
    refresh: 'Refresh',
    startOk: 'Gateway started',
    startFail: 'Start failed',
    stopOk: 'Gateway stopped',
    stopFail: 'Stop failed',
    restartOk: 'Gateway restarted',
    restartFail: 'Restart failed',
    javaHome: 'Java Home',
    javaHomePlaceholder: 'Empty = java from PATH; Java 21+ required',
    checkJava: 'Check Java',
    port: 'Port',
    host: 'Host',
    config: 'Config URL',
    configPlaceholder: 'http://fty.xxooo.cf/tv (loaded on start, optional)',
    spider: 'Spider URL',
    spiderPlaceholder: 'Empty = default network jar; file:/// or https://...;md5;...',
    dataDir: 'Data dir',
    dataDirPlaceholder: 'Empty = gateway-data under app data',
    autoStart: 'Auto start',
    autoStartTip: 'Start gateway when Player launches',
    token: 'Token',
    tokenPlaceholder: 'Required for non-local bind',
    saveLabel: ' ',
    save: 'Save settings',
    saveRestart: 'Save & restart',
    saveOk: 'Settings saved',
    saveFail: 'Save failed',
    jarMissing: 'resources/gateway/gateway.jar not found',
    logTitle: 'Gateway log',
    logEmpty: 'No log yet',
  },
  site: {
    name: 'name',
